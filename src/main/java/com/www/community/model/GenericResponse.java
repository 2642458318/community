...
public class GenericResponse {
    ...
    public static final ResponseEntity<GenericResponse> ok() {
        return ResponseEntity.ok(OK_RESP);
    }

    public static final ResponseEntity<GenericResponse> ng(String msg) {
        GenericResponse resp = new GenericResponse(CODE_NG);
        resp.setMsg(msg);
        return ResponseEntity.ok(resp);
    }

    public static final ResponseEntity<GenericResponse> okWithMsg(String msg){
